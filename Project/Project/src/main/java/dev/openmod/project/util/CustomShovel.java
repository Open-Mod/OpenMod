...
public class CustomShovel extends ShovelItem implements GeoItem {
    private AnimatableInstanceCache cache = new SingletonAnimatableInstanceCache(this);
    private String name;
    private boolean custom;
    public CustomShovel(String name, String modelType, Tier tier, int attackDamage, float attackSpeed, Properties properties) {
