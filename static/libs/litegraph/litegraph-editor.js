function Editor(container_id, options) {
  ...
  //fill container
  var html =
    "<div class='content'><div class='editor-area'><canvas class='graphcanvas' tabindex=10></canvas></div></div>";
  ...
  graphcanvas.background_image = "images/grid.png";
  ...
  //add stuff
  //this.addToolsButton("loadsession_button","Load","images/icon-load.png", this.onLoadButton.bind(this), ".tools-left" );
  //this.addToolsButton("savesession_button","Save","images/icon-save.png", this.onSaveButton.bind(this), ".tools-left" );
...
Editor.prototype.onPlayButton = function () {
  ...
  if (graph.status == LGraph.STATUS_STOPPED) {
    button.innerHTML = "<img src='images/icon-stop.png'/> Stop";
    graph.start();
  } else {
    button.innerHTML = "<img src='images/icon-play.png'/> Play";
    graph.stop();
  }
};
...
Editor.prototype.onLiveButton = function () {
  ...
  var url = this.graphcanvas.live_mode
    ? "images/gauss_bg_medium.jpg"
    : "images/gauss_bg.jpg";
  var button = this.root.querySelector("#livemode_button");
  button.innerHTML = !is_live_mode
    ? "<img src='images/icon-record.png'/> Live"
    : "<img src='images/icon-gear.png'/> Edit";
};
